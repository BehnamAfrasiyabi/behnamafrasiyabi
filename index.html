...
<body>
  ...
  <nav class="navbar">
    <div class="container">
      <div class="logo">Behnam Afrasiyabi</div>
      <ul class="nav-links">
    ...
    <div class="container">
      <div class="hero-content">
        <div class="hero-image">
          <img src="images/profile.png" alt="Behnam Afrasiyabi" />
        </div>
        <div class="hero-text">
          ...
          <div class="contact-info">
            ...
            <div class="info-item">
              ...
              <a href="https://linkedin.com/in/behnam-afrasiyabi" target="_blank">linkedin.com/in/behnam-afrasiyabi</a>
            </div>
          </div>
      ...
      <div class="projects-grid">
        <div class="project-card">
          <div class="project-image">
            <img class="project-image-trigger" src="https://placehold.co/600x400/1a1a1a/FFFFFF?text=T-Sim200V3" alt="T-Sim200V3" />
          </div>
        ...
        <div class="project-card">
          <div class="project-image">
            <img class="project-image-trigger" src="https://placehold.co/600x400/1a1a1a/FFFFFF?text=IoT+Modules" alt="IoT Modules" />
          </div>
          <div class="project-content">
        ...
        <div class="project-card">
          <div class="project-image">
            <img class="project-image-trigger" src="https://placehold.co/600x400/1a1a1a/FFFFFF?text=Sensor+Tester" alt="Sensor Tester" />
          </div>
          <div class="project-content">
        ...
        <div class="project-card">
          <div class="project-image">
            <img class="project-image-trigger" src="https://placehold.co/600x400/1a1a1a/FFFFFF?text=Smart+Home" alt="Smart Home" />
          </div>
          <div class="project-content">
        ...
        <div class="certifications-grid">
          <div class="cert-card" data-cert="1">
            <div class="cert-image">
              <img src="https://placehold.co/280x380/1a1a1a/FFFFFF?text=Altium+Cert" alt="Altium Designer Certificate">
            </div>
          ...
          <div class="cert-card" data-cert="2">
            <div class="cert-image">
              <img src="https://placehold.co/280x380/1a1a1a/FFFFFF?text=AutoCAD+Cert" alt="AutoCAD Electrical Certificate">
            </div>
            <div class="cert-content">
          ...
          <div class="cert-card" data-cert="3">
            <div class="cert-image">
              <img src="https://placehold.co/280x380/1a1a1a/FFFFFF?text=AVR+Cert" alt="AVR Microcontroller Certificate">
            </div>
            <div class="cert-content">
  ...
  <div id="3dModal" class="modal">
    <div class="modal-3d-content">
      ...
      <div id="3dViewer" style="width: 100%; height: 80vh;"></div>
    </div>
  </div>
